...
<template>
  ...
  <footer class="relative flex items-center bottom-0 pt-10 pb-10 justify-center w-full">
    <p class="text-gray-400 dark:text-gray-600 text-center text-md">© Copyright 2024, <a class="text-sky-300 hover:underline" href="https://autobot-by-polongdev.onrender.com">PolongDev</a> Allrights reserved.</p>
  </footer>
  </div>
  <Toaster />
</template>
